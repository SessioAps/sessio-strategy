...
export default function AddContact() {
  const [f, setF] = useState({ name: "", org: "", role: "", note: "" });
  ...
  return (
    <form onSubmit={submit} className="grid gap-2 rounded-2xl border border-border bg-surface/40 p-4 sm:grid-cols-[1fr_1fr_1fr_1.5fr_auto]">
